...
if (!empty($_POST['stripeToken'])) {
	...
	// set API Key
	$stripe = array(
		"SecretKey" => "sk_test_51PEXkeEvtyVHuMvy0XO2Da7JIemCgR2MtLXUXGCsYZROtMWH1cS08LWilxwRx5PWSzIsHzjEpW7JZ8nNOPByIMxg00HlphZiWQ",
		"PublishableKey" => "pk_test_51PEXkeEvtyVHuMvyLnP8TtXVW5GqeCSSZoY2AO27gwTcuGLiihkvOujdcgjGzbLvriKtx8SXDSJOz1HTmqRRZi4a00SYbmicce"
	);
